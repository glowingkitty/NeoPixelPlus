...
class Transition:
    ...
    def glow(self):
        ...
        while True:
            ...
            difference = [
                target_color[0]-self.led_strip.leds[self.selected_leds[0]][0],
                target_color[1]-self.led_strip.leds[self.selected_leds[0]][1],
                target_color[2]-self.led_strip.leds[self.selected_leds[0]][2],
            ]
